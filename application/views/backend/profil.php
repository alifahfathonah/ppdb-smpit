                            ...
                            <table class="table table-stripped">
					            ...
					            <tbody>
					                ...
					                <tr>                      
					                  ...
					                  <td data-title="foto" style="text-align:center !important;"><img src="<?php 
					                  ...
					                  <td><?php 
                                        ...
                                        $text  = word_limiter($data['keterangan'],8);
					                  ...
					                  <td data-title="Aksi" style="text-align:center">
					                    ...
					                    <a 
                                            ...
                                            data-foto="<?php echo base_url().'assets/frontend/images/profil/'.$data['foto'] ?>"

                                            data-keterangan="<?php echo $data['keterangan'] ?>"

                                            data-tingkatan_guru="<?php echo $data['tingkatan_guru'] ?>"
					                    ...
					                    <a href="<?php echo base_url().'admin/profil_hapus/'.$data['id'];?>" data-original-title="Hapus Data" class="btn btn-danger tooltips" data-toggle="tooltip" data-placement="top" title="" onclick="return confirm('Apakah anda yakin akan menghapus data ini?')"><i class="fa fa-times fa-fw"></i></a>
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title">Tambah <?php echo $status; ?></h4>

            </div>

            <div class="modal-body">

                <form class="cmxform form-horizontal adminex-form" id="signupForm" action="<?=base_url()?>Admin/profil_tambah" method="post" enctype="multipart/form-data" novalidate="novalidate" role="form">
                    ...
                    <div class="form-group ">
                        ...
                        <label for="avatar" class="control-label col-lg-2">Foto</label>

                        <div class="col-lg-10">

                          <div class="fileupload fileupload-new" data-provides="fileupload">

                              <div class="fileupload-new thumbnail" style="width:100%;height:200px; padding:10px; height: 40px">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <select name="jabatan" class="form-control">
                              ...
                              <option value="4">Waka. Sarana & Prasarana</option>
                              <option value="5">Waka. Humas</option>
                              <option value="6">Guru Biasa</option>
                            </select>
                        </div>
                    </div>
                    <?php } ?>
...
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="ubah_profil" class="modal fade">
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title">Ubah Data <?php echo $status; ?></h4>

            </div>

            <div class="modal-body">

                <form class="cmxform form-horizontal adminex-form" id="signupForm" action="<?=base_url()?>admin/profil_update" method="post" enctype="multipart/form-data" novalidate="novalidate" role="form">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-lg-10">
                          ...
                          <div class="fileupload fileupload-new" data-provides="fileupload">
                              ...
                              <div class="fileupload-new thumbnail" style="width:100%; padding:10px; height:200px;">
                    ...
                    <div class="form-group">
                        <label class="col-lg-2 col-sm-2 control-label">Jabatan</label>
                        <div class="col-lg-10">
                            <select name="jabatan" class="form-control" id="Tingkatan_guru">
                              <option value="">-Pilih-</option>
                              <option value="1">Kepala Sekolah</option>
                              <option value="2">Waka. Kurikulum</option>
                              <option value="3">Waka. Kesiswaan</option>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#ubah_profil').on('show.bs.modal', function (event) {
            ...
            modal.find('#Tingkatan_guru option').each(function(){
                  if ($(this).val() == div.data('tingkatan_guru'))
