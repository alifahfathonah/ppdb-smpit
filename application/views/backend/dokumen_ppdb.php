        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                	...
                	<form class="cmxform form-horizontal adminex-form" id="signupForm" action="<?=base_url()?>Admin/dokumen_ppdb_ubah" method="post" enctype="multipart/form-data" novalidate="novalidate" role="form">
                                ...
                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                    <div class="fileupload-new thumbnail" style="width:100%; padding:10px;height:40px">
                                        <?php if ($data[0]['file']==""){
                                            ...
                                            <a target="_blank" href='<?php echo base_url().'assets/frontend/uploads/dokumen_ppdb/'.$data[0]['file'];?>'><?php echo $data[0]['file']?></a>
                                        <?php } ?>
                                    </div>
